# -*- coding: utf-8 -*-
# @Author             : GZH
# @Created Time       : 2022/11/14 12:35
# @Email              : guozh29@mail2.sysu.edu.cn
# @Last Modified By   : GZH
# @Last Modified Time : 2022/11/14 12:35
...
if __name__ == '__main__':
    ...
    x_train = [data_dir + 'x_train_2.npy']
    y_train = [data_dir + 'y_train_2.npy']
    x_test = [data_dir + 'x_test_2.npy']
    y_test = [data_dir + 'y_test_2.npy']
    client_id = ['Client2']
